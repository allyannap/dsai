...
# Note: repos parameter is needed when running non-interactively (e.g., with Rscript)
install.packages(c("usethis", "gert", "credentials"), repos = "https://cloud.r-project.org")
...
tryCatch({
  ...
  message("git_vaccinate() timed out or failed, but this is usually okay. Continuing...")
})
